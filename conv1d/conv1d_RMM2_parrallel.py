...
def models(params):
    ...
    print('Train correlation of '+str(i)+' '+str(j),train_corr[i,k,j])
    ...
    print('Test1 correlation of '+str(i)+' '+str(j),test1_corr[i,k,j])
    ...
    print('Test2 correlation of '+str(i)+' '+str(j),test2_corr[i,k,j])
...
np.save('train_rmm2_job.npy',train_corr)
np.save('test1_rmm2_job.npy',test1_corr)
np.save('test2_rmm2_job.npy',test2_corr)
