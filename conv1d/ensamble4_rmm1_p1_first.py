...
def run(i):
    ...
    if (test1_corr_>0.825) & (test2_corr_>0.875):
        ...
        rmm1_05_15.to_csv('/home/cccr/supriyo/panini/filtered_data/historical/JGRJD/conv1d/ensamble4/rmm1_1905_2015_'+str(i)+'p1.txt')
        print(train_corr_,test1_corr_,test2_corr_)
        model.save("/home/cccr/supriyo/panini/filtered_data/historical/JGRJD/conv1d/ensamble4/model_rmm1_p1_"+str(i)+".h5")
