...
def run(i):
    ...
    if (test1_corr_>0.833) & (test2_corr_>0.833):
        ...
        rmm2_05_15.to_csv('/home/cccr/supriyo/panini/filtered_data/historical/JGRJD/conv1d/ensamble4/rmm2_1905_2015_'+str(i)+'.txt')
        print(train_corr_,test1_corr_,test2_corr_)
        model.save("/home/cccr/supriyo/panini/filtered_data/historical/JGRJD/conv1d/ensamble4/model_rmm2_"+str(i)+".h5")
