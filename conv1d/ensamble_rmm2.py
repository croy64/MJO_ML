...
def run(i):
    ...
    if (test1_corr_>0.835) & (test2_corr_>0.835):
        ...
        rmm2_05_15.to_csv('/home/cccr/supriyo/panini/filtered_data/historical/JGRJD/conv1d/ensamble2/rmm2_1905_2015_'+str(i)+'.txt')
        print(train_corr_,test1_corr_,test2_corr_)
        model.save("/home/cccr/supriyo/panini/filtered_data/historical/JGRJD/conv1d/ensamble2/model_rmm2_"+str(i)+".h5")
